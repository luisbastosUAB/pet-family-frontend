<template>
  ...
  <b-container fluid>
     ...
     <!-- breadcrumb-area -->
     <section class="breadcrumb-area breadcrumb-bg" :style="{'background-image': `url(${require('@/assets/img/bg/breadcrumb_bg.jpg')})`}">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Lista de cães</h2>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-9">
                            <div class="section-title text-center mb-65">
                                ...
                                <h5 class="sub-title">Conhece os nossos cães</h5>
                                <h2 class="title">Cães em lista para adoção</h2>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="adoption-shop-item">
                                <div class="adoption-shop-thumb">
                                    ...
                                    <a href="shop-details.html" class="btn">Adoptar <img src="../assets/img/icon/w_pawprint.png" alt=""></a>
                                </div>
                                <div class="adoption-shop-content">
                                    ...
                                    <div class="adoption-meta">
                                        <ul>
                                            ...
                                            <li><i class="far fa-calendar-alt"></i> Nascimento : 2021</li>
                                        </ul>
                                    </div>
                                    <div class="adoption-rating">
                                        <ul>
                                            ...
                                            <li class="price">Processo : <span>Grátis</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="adoption-shop-content">
                                    ...
                                    <div class="adoption-meta">
                                        <ul>
                                            ...
                                            <li><i class="far fa-calendar-alt"></i> Nascimento : 2020</li>
                                        </ul>
                                    </div>
                                    <div class="adoption-rating">
                                        <ul>
                                            ...
                                            <li class="price">Processo : <span>$30</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="adoption-shop-content">
                                    ...
                                    <div class="adoption-rating">
                                        <ul>
                                            ...
                                            <li class="price">Processo : <span>$29</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="adoption-shop-content">
                                    ...
                                    <div class="adoption-rating">
                                        <ul>
                                            ...
                                            <li class="price">Processo : <span>$39</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="footer-top-area footer-bg">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-3">
                            <div class="footer-widget">
                                ...
                                <div class="fw-insta">
                                    <ul>
                                        <li><a href="#"><img src="../assets/../assets/img/images/insta_img01.png" alt=""></a></li>
                                        <li><a href="#"><img src="../assets/../assets/img/images/insta_img02.png" alt=""></a></li>
                                        <li><a href="#"><img src="../assets/../assets/img/images/insta_img03.png" alt=""></a></li>
                                        <li><a href="#"><img src="../assets/../assets/img/images/insta_img04.png" alt=""></a></li>
                                        <li><a href="#"><img src="../assets/../assets/img/images/insta_img05.png" alt=""></a></li>
                                        <li><a href="#"><img src="../assets/../assets/img/images/insta_img06.png" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="footer-shape"><img src="../assets/../assets/img/images/footer_shape01.png" alt=""></div>
                <div class="footer-shape shape-two"><img src="../assets/../assets/img/images/footer_shape02.png" alt=""></div>
            </div>
        </footer>
...
<script>
//import { FETCH_DOGS } from "@/store/dogs/dogs.constants";
