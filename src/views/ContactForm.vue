<template>
  <b-container fluid>
    ...
    <section
      ...
      :style="{
        'background-image': `url(${require('@/assets/img/bg/breadcrumb_bg.jpg')})`
      }"
    >
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="breadcrumb-content">
              <h2 class="title">Contacto-nos</h2>
          ...
          <div class="row justify-content-center justify-content-lg-between">
            <div class="col-lg-6 col-md-8 order-2 order-lg-0">
              <div class="contact-title mb-20">
                <h5 class="sub-title">Contacta-nos</h5>
                <h2 class="title">Como podemos ajudar?<span>.</span></h2>
              </div>
              <div class="contact-wrap-content">
                <p>
                  Adoptar um cão é um compromisso para muitos anos. Antes de
                  tomar essa decisão, aconselhamos a leitura do nosso Guia de
                  Adopção de Cães
                </p>
                <form action="#" class="contact-form">
                  ...
                  <div class="form-grp checkbox-grp">
                    ...
                    <label for="checkbox"
                      >Não mostrar o endereço de email</label
                    >
                  </div>
                  <button type="button" class="btn rounded-btn">Enviar</button>
                </form>
              </div>
            </div>
    ...
    <footer>
      <div class="footer-top-area footer-bg">
          ...
          <div class="row justify-content-between">
            <div class="col-3">
              <div class="footer-widget">
                <div class="f-logo">
                  <a href="index.html"
                    ><img src="../assets/../assets/img/logo/logo.png" alt=""
                  /></a>
                </div>
                ...
                <div class="fw-insta">
                  <ul>
                    <li>
                      <a href="#"
                        ><img
                          src="../assets/../assets/img/images/insta_img01.png"
                          alt=""
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img
                          src="../assets/../assets/img/images/insta_img02.png"
                          alt=""
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img
                          src="../assets/../assets/img/images/insta_img03.png"
                          alt=""
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img
                          src="../assets/../assets/img/images/insta_img04.png"
                          alt=""
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img
                          src="../assets/../assets/img/images/insta_img05.png"
                          alt=""
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img
                          src="../assets/../assets/img/images/insta_img06.png"
                          alt=""
                      /></a>
                    </li>
                  </ul>
        ...
        <div class="footer-shape">
          <img src="../assets/../assets/img/images/footer_shape01.png" alt="" />
        </div>
        <div class="footer-shape shape-two">
          <img src="../assets/../assets/img/images/footer_shape02.png" alt="" />
        </div>
      </div>
    </footer>
