...
<form @submit.prevent="update">
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9 form-group">
      <input name="name" v-model="user.name" type="text" class="form-control" id="name" value="Kevin Anderson">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9 form-group">
      <textarea name="description" v-model="user.description" class="form-control" id="description" style="height: 100px"></textarea>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9 form-group">
      <select id="active" class="form-control form-control-lg" v-model="user.active">
