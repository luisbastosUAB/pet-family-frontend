<template>
  <div id="sticky-header" class="menu-area">
            ...
            <nav class="menu-nav show">
              ...
              <div class="navbar-wrap main-menu d-none d-lg-flex">
                <ul class="navigation">
                  ...
                  <li>
                    <router-link active-class="active" to="/doglist"
                      >Lista de cães</router-link
                    >
                  </li>
                  <li>
                    <router-link active-class="active" to="/contactos"
    ...
    <div
      class="header-shape"
      data-background="../assets/img/bg/header_shape.png"
    ></div>
  </div>
</template>
